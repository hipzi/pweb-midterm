...
Route::middleware('auth-seller')->group(function () {
    ...
    Route::get('/seller/published-software', [SellerController::class, 'viewSoftwareList'])->name('seller.software.list');
    Route::get('/seller/published-software/data', [SellerController::class, 'softwareList'])->name('seller.software.list.data');
