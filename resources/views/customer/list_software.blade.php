...
@section('title', 'List Software')

@section('content')
<div class="container" style="padding-top:100px">
    <div class="col-md-12 col-sm-12">
        <h2 class="table-title">My Software</h2>
        <table id="listSoftware" class="table table-bordered table-striped table-bordered table-hover dataTable"
            data-ajaxurl="{{ route('software.data') }}">
...
<script src="{{asset('js/customer/list_software.js') }}" defer></script>
@endsection